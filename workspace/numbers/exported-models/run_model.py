...
IMAGE_DIR = '/home/mark/src/mmor-crowfall-models/workspace/numbers/images/test'
IMAGE_PATHS = [f'{IMAGE_DIR}/{i}' for i in os.listdir(IMAGE_DIR) if '.png' in i][0:10]

PATH_TO_MODEL_DIR = '/home/mark/src/mmor-crowfall-models/workspace/numbers/exported-models/ssd_mobilenet_v2_fpnlite_320x320_v1'

PATH_TO_LABELS = '/home/mark/src/mmor-crowfall-models/workspace/numbers/annotations/label_map.pbtxt'
